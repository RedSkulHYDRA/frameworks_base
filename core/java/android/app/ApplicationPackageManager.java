...
public class ApplicationPackageManager extends PackageManager {
    ...
    public boolean hasSystemFeature(String name, int version) {
        ...
        if (Arrays.asList(featuresTensor).contains(name) &&
            ...
            if (packageName.contains("com.google.android.as") || packageName.contains("com.google.android.apps.recorder") || packageName.contains("com.google.android.apps.nexuslauncher")) {
                return false;
            }
        }
